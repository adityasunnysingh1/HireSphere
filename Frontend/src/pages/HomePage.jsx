    ...
    <div className="min-h-screen bg-linear-gradient-to-br from-base-100 via-base-200 to-base-300">
      ...
      <nav className="bg-base-100/80 backdrop-blur-md border-b border-primary/20 sticky top-0 z-50 shadow-lg">
        <div className="max-w-7xl mx-auto p-4 flex items-center justify-between ">
          ...
          >
            <div className="size-10 rounded-xl bg-linear-gradient-to-br from-primary via-secondary to-accent flex items-center justify-center shadow-lg">
              <SparklesIcon className="size-6 text-white " />
            </div>
            <div className="flex flex-col">
              <span className="font-black text-xl bg-linear-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent font-mono tracking-wider">
                Vynterview
              </span>
        ...
        <div className="grid lg:grid-cols-2 items-center gap-12">
          ...
          <div className="space-y-8">
            ...
            <h1 className="text-5xl lg:text-7xl font-black leading-tight">
              <span className="bg-linear-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent">
                Code Together,
              </span>
              <br />
          ...
          className="w-full h-auto rounded-3xl shadow-2xl border-4
            border-base-100 hover:scale transition-transform duration-500" 
            />
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body items-center text-center">
              ...
              <h3 className="card-title">HD Video Chat</h3>
